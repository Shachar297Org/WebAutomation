...
#                            object_test(pytest.lazy_fixture('swPath'), pytest.lazy_fixture('swVersion'), pytest.lazy_fixture('devicesFamily'),
#                            pytest.lazy_fixture('deviceType'), pytest.lazy_fixture('deviceModel'), pytest.lazy_fixture('swFileType'), 
#                            pytest.lazy_fixture('swSupportedVersion'), pytest.lazy_fixture('swInstallType'), pytest.lazy_fixture('numberOfDevices')))
#
...
#        test_device = Device(serial_number=deviceSN, model=deviceModel, device=deviceType)
#
#        test_group_name = TEST_GROUP_PREFIX + deviceSN.split('-').pop().join('-')
#
#        devices_page = login_as(super_admin_credentials)
#                
#        devices_page.reload().search_by(deviceSN)
